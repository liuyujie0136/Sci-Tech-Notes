...
- 查看分群信息，就是测序的样品大概分成几个群。如2015年大豆重测序文章的图\[17\]:
    ...
    ![](https://upload-images.jianshu.io/upload_images/3454743-9868c48699f60931.png?imageMogr2/auto-orient/strip|imageView2/2/w/745/format/webp)
...
![](https://pic1.zhimg.com/v2-d4c7b946402a48ce47bf0b6679ad6630_b.jpg)

![](https://pic1.zhimg.com/80/v2-d4c7b946402a48ce47bf0b6679ad6630_1440w.jpg)
...
在研究空间种群关系中，有一个很重要的参数就是亲代和子代空间距离的方差，即扩散距离。如果群体间分化随空间距离增大而增大，那么这种现象也被称为**isolation by distance**(IBD,注意和之前讨论的IBD – identical bydescent 不一样)。我们可以计算不同群体之间的Fst，然后将Fst/(1-Fst)作为纵坐标和空间距离作图，拟合回归模型，一次来判断群体之间是否存在IBD。IBD的存在意味着群体之间存在迁徙\-漂变平衡的存在。回归模型的斜率取决于有效群体数量（或群体密度）和扩散距离的乘积。

当然研究种群的空间关系，更常用的是主成分分析（PCA），PCA起到降维的作用，例如使用PCA和空间插值，人们研究了欧洲人口的迁徙，根据第一主成分推测人口从东南向西北迁徙。

![图片](https://mmbiz.qpic.cn/mmbiz_png/28HEmLRCgZukp6rmzVTEKialI7VKicFhIL4PEeL2AibjyavYCz6tE5L5Fz4b4wegZJ5qIFYsyGCSgxIENtHW3skAA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
